...
public class listGetter implements Runnable{
    ...
    public listGetter(LinkedList<exchangeItem> exchangeItems, String letters, Handler handler) {
    ...
    public void run() {
        ...
        for(int i = 0; i < items.size(); i++){
            String code =  items.get(i).getCountryCode();
